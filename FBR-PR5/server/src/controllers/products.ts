...
const products = [
  ...
  },
  {
    ...
    category: "Бытовая техника",
    description:
      "Печь Solo с грилем, объем 20 литров, механическое управление.",
    price: 6500,
    quantity: 3,
  },
  {
    ...
    description:
      "Двухкамерный холодильник с системой No Frost, объем 280 литров.",
    price: 45000,
    quantity: 2,
  },
  {
  ...
  },
  {
    ...
    description:
      "Профессиональный фен с ионизацией и тремя режимами температуры.",
    price: 2900,
    quantity: 14,
  },
  {
